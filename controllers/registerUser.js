...
const { PASS_USER, CLIENT_ID, CLIENT_SECRET, REDIRECT_URI, REFRESH_TOKEN } = process.env;
...
module.exports = async function(body) {
	...
	async function sendMail() {
		...
		const mailOptions = {
			...
			text: `Para finalizar la confirmación de tu cuenta, hacé click en este link: https://dingbellapp.onrender.com/resto/mail-confirmation/${encodedToken}`,
			html: `
				<h1>Bienvenido a DingBell! 🛎️</h1>
				<p>
					Sólo queda un paso para aprovechar los beneficios de DingBell...<br>
					hacé click en este 
					<a href="https://dingbellapp.onrender.com/resto/mail-confirmation/${encodedToken}">LINK</a> 
